...
Public Class ajou
    ...
    Private Sub Ajouter_Click(sender As Object, e As EventArgs) Handles Ajouter.Click
        If Nom.Text = "" Or tel.Text = "" Or prenom.Text = "" Or cin.Text = "" Or filiere.Text = "" Or bourse.Text = "" Or Inscription.Text = "" Or fodate.Text = "" Then
        ...
        Else
            ...
            Else
                ...
                CMD.CommandText = "INSERT INTO stagiaire (inscription,filiere,duree,nom,prenom,cin,bourse,date,user,TEL) VALUES('" & Inscription.Text & "','" & filiere.Text & "','" & fodate.Text & "','" & Nom.Text & "','" & prenom.Text & "','" & cin.Text & "','" & bourse.Text & "','" & DateTimePicker1.Text & "','" & user.Text & "','" & tel.Text & "')"
                CMD.ExecuteNonQuery()
                CMD1.Connection = MYConnectionsql
                CMD1.CommandText = "INSERT INTO payement (inscription,recu,date,montant,user,cin,filiere,nom,prenom,TEL) VALUES('" & Inscription.Text & "','0','" & DateTimePicker1.Text & "','0','" & user.Text & "','" & cin.Text & "','" & filiere.Text & "','" & Nom.Text & "','" & prenom.Text & "','" & tel.Text & "')"
