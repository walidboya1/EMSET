...
Public Class modif_ad
    Sub act()
        ...
        Try
            ...
            Dim Query As String
            Query = "SELECT * FROM emset.stagiaire"
    ...
    Sub rech()
        ...
        Try
            MySqlConnection.Open()
            Dim Query As String
            Query = "SELECT * FROM emset.stagiaire WHERE cin ='" & cin.Text & "'"
            Dim Command As New MySqlCommand
            Command = New MySqlCommand(Query, MySqlConnection)
            MysqlAdapter.SelectCommand = Command
            MysqlAdapter.Fill(DatabaseSet)
    ...
    Sub rech2()
        ...
        Try
            MySqlConnection.Open()
            Dim Query As String
            Query = "SELECT * FROM emset.stagiaire WHERE Inscription ='" & Inscription.Text & "'"
            Dim Command As New MySqlCommand
            Command = New MySqlCommand(Query, MySqlConnection)
            MysqlAdapter.SelectCommand = Command
            MysqlAdapter.Fill(DatabaseSet)
    ...
    Sub rech3()
        ...
        Try
            MySqlConnection.Open()
            Dim Query As String
            Query = "SELECT * FROM emset.stagiaire WHERE filiere ='" & filiere.Text & "'"
            Dim Command As New MySqlCommand
            Command = New MySqlCommand(Query, MySqlConnection)
            MysqlAdapter.SelectCommand = Command
            MysqlAdapter.Fill(DatabaseSet)
    ...
    Private Sub Modifier_Click(sender As Object, e As EventArgs) Handles Modifier.Click
        ...
        Else
            ...
            Try
                MySqlConnection.Open()
                Dim Query As String
                Query = "UPDATE emset.stagiaire SET Inscription='" & Inscription.Text & "',filiere='" & filiere.Text & "',duree='" & fodate.Text & "',nom='" & Nom.Text & "',prenom='" & prenom.Text & "',cin='" & cin.Text & "',Bourse='" & Bourse.Text & "',date='" & DateTimePicker1.Text & "',user='" & user.Text & "',Observation='" & Observation.Text & "',TEL='" & TEL.Text & "'WHERE id='" & IDCompte.Text & "'"
                COMMAND = New MySqlCommand(Query, MySqlConnection)
