...
<body>
        ...
        <div class="container">
            ...
            <div class="topbar-right">
                <ul class="topbar-nav nav">
                    ...
                    <li class="nav-item"><a class="nav-link  active" style="color: blue;">Professeur</a></li>
    ...
    <header class="header header-inverse h-fullscreen">
        <div class="header-overlay opacity-90" style="background-color: yellow;"></div>
        <div class="container text-center">
            <div class="row h-full">
                <div class="col-12 col-lg-8 offset-lg-2 align-self-center">
                    <h5 class="display-4">Professeur</h5>
                </div>
            </div>
        </div>
    </header>
    ...
    <a class='btn btn-primary' href='cadre_signup.php?cadre=1' data-provide='lightbox'>Ajouter Utilisateur</a>
    <!-- END Main container -->
