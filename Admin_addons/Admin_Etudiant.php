...
<body style="overflow: scroll;overflow:auto;">
        ...
        <div class="container">
            ...
            <div class="topbar-right">
                <ul class="topbar-nav nav">
                    <li class="nav-item"><a class="nav-link  active" style="color: blue;">Etudiant</a></li>
                    <li class="nav-item"><a class="nav-link" style="color: blue;"
                            href="Admin_Professeur.php">Professeur</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" style="color: blue;" href="Admin_Avis.php">Avis</a></li>
    ...
    <!---- END topbar---->
    <!-- Header -->
    <header class="header header-inverse h-fullscreen header-expand">
        <div class="header-overlay opacity-90" style="background-color: #5BFF62;"></div>
        <div class="container text-center">
            <div class="row h-full">
                <div class="col-12 col-lg-8 offset-lg-2 align-self-center">
                    <h5 class="display-4">Etudiant</h5>
                </div>
            </div>
        </div>
    </header>
    ...
    <a class='btn btn-primary' href='Etudiant_signup.php' data-provide='lightbox'>Ajouter Etudiant</a>
    <!-- END Main container -->
