...
<body>
        ...
        <div class="container">
            ...
            <div class="topbar-right">
                <ul class="topbar-nav nav">
                    ...
                    <li class="nav-item"><a class="nav-link  active" style="color: blue;">Activite</a></li>
        ...
        <div class="container text-center">
            <div class="row h-full">
                <div class="col-12 col-lg-8 offset-lg-2 align-self-center">
                    <h5 class="display-4">Activite</h5>
                </div>
            </div>
        </div>
    </header>
    ...
    <a class='btn btn-primary' href='Activite_Add.php' data-provide='lightbox'>Ajouter Activite</a>
    <!-- END Main container -->
