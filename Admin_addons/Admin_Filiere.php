...
<body>
        ...
        <div class="container">
            ...
            <div class="topbar-right">
                <ul class="topbar-nav nav">
                    ...
                    <li class="nav-item"><a class="nav-link  active" style="color: blue;">Filiere</a></li>
    ...
    <a class='btn btn-primary' href='Filiere_signup.php' data-provide='lightbox'>Ajouter Filiere</a>
    <!-- END Main container -->
