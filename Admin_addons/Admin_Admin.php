...
<body>
        ...
        <div class="container">
            ...
            <div class="topbar-right">
                <ul class="topbar-nav nav">
                    ...
                    <li class="nav-item"><a class="nav-link  active" style="color: blue;">Admin</a></li>
                </ul>
    ...
    <a class='btn btn-primary' href='cadre_signup.php?cadre=2' data-provide='lightbox'>Ajouter Utilisateur</a>
    <!-- END Main container -->
