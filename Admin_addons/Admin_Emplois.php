...
<body>
        ...
        <div class="container">
            ...
            <div class="topbar-right">
                <ul class="topbar-nav nav">
                    ...
                    <li class="nav-item"><a class="nav-link  active" style="color: blue;">Emplois</a></li>
    ...
    <a class='btn btn-primary' href='Emplois_Add.php' data-provide='lightbox'>Ajouter Emplois</a>
    <!-- END Main container -->
