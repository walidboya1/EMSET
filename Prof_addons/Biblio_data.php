...
if ($Cadreid == $_SESSION['login_user']){
    ...
    echo "<tr><td>".$id."</td><td>".$URL."</td><td>".$Date."</td><td>".$nom."</td><td></td></tr>";
  }};

    echo "<tr><td><a class='btn btn-primary' href='biblio_Add.php' data-provide='lightbox'>Ajouter biblio</a></td></tr>";
?>
