        ...
        <div class="container">
            ...
            <div class="topbar-right">
                <ul class="topbar-nav nav">
                    ...
                    <li class="nav-item"><a class="nav-link" style="color: blue;" href="Etudiant_Biblio.php">Biblio</a></li>
                    <li class="nav-item"><a class="nav-link" style="color: blue;" href="Etudiant_Emplois.php">Emplois</a></li>
                    <li class="nav-item"><a class="nav-link  active" style="color: blue;">Info Personnel</a></li>
                </ul>
        ...
        <div class="container text-center">
            <div class="row h-full">
                <div class="col-12 col-lg-8 offset-lg-2 align-self-center">
                    <h5 class="display-4">Informations Personnel</h5>
                </div>
            </div>
        </div>
    </header>
